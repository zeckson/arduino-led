package com.github.zeckson.ledequalizer.common.logger
...
class LogView : TextView, LogNode {
    ...
    override fun println(priority: Int, tag: String?, msg: String, tr: Throwable?) {
        ...
        when (priority) {
            android.util.Log.VERBOSE -> priorityStr = "VERBOSE"
            android.util.Log.DEBUG -> priorityStr = "DEBUG"
            android.util.Log.INFO -> priorityStr = "INFO"
            android.util.Log.WARN -> priorityStr = "WARN"
            android.util.Log.ERROR -> priorityStr = "ERROR"
            android.util.Log.ASSERT -> priorityStr = "ASSERT"
            else -> {
            }
        }
